...
class GDFM_Model(BaseModel):
    """ This class implements the GDFM model, for learning a mapping from input images to output images given paired data.
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        For GDFM, we do not use image buffer
